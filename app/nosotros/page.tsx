        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              Bienvenido a Gateway I.T, una empresa especializada en brindar
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              En Gateway I.T, creemos que nuestro capital humano es nuestro
              mayor activo y, por lo tanto, invertimos en el desarrollo y
              capacitación constante de nuestro equipo. Esto nos permite ofrecer
              soluciones integradas que se adaptan a las necesidades específicas
              de cada cliente.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Nuestro enfoque se basa en la tecnología 4Ri y 5Ri, lo que nos
              permite ofrecer soluciones innovadoras que maximizan la eficiencia
...
<section className="py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            En <strong>Gateway I.T</strong>, somos pioneros en la integración de
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
            {expertise.map((item, index) => (
              ...
              >
                <Briefcase className="w-6 h-6 text-[#0b90d8] mr-4" />
